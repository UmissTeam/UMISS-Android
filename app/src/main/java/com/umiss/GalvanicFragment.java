...
public class GalvanicFragment extends Fragment {
    ...
    private void plot(View view){
        ...
        UMISSRest.get(UMISSRest.GALVANIC, token, new FutureCallback<JsonObject>() {
            @Override
            public void onCompleted(Exception e, JsonObject result) {
                try {
                    ...
                    for (int i = 0; i < r.size(); i++) {
                        ...
                        String resistance = r.get(i).getAsJsonObject().get("attributes").
                                getAsJsonObject().get("resistance").getAsString();
                        list.add(resistance);
                        Log.d("resistance", resistance);
                    }
